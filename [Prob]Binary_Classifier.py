...
if __name__ == "__main__":
    if net_input(data, weight) is None:
        print("\nnet_input() not defined")
    else:
...
if __name__ == "__main__":
    if predict(data, weight) is None or activation(net_input(data, weight)) is None:
        print("\npredict() or activation() is not defined")
    else:
...
if __name__ == "__main__":
    if update_weight(data, label) is None:
        print("\nupdate() not defined")
    else:
